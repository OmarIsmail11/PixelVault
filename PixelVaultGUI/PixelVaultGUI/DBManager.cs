...
namespace DBapplication
{
    public class DBManager
    {
        ...
        static string DB_Connection_String = @"Data Source=MICKOO\SQLEXPRESS;Initial Catalog=PixelVault;Integrated Security=True;Encrypt=False";        // Reda   static string DB_Connection_String = @"Data Source=OMAR-REDA\SQLEXPRESS;Initial Catalog=PixelVault;Integrated Security=True;Encrypt=False";
