	...
	TournamentType VARCHAR(30) NOT NULL CHECK (TournamentType IN ('1v1', 'Teams')),
	...
	('EVO', 500, 500, 'Tekken 7', '1v1', 'North America', '2023-07-07', 'Steam', 250000.00,'Open'),
	('ESL Pro League', 1000, 1000, 'Valorant', 'Teams', 'Asia', '2023-02-01', 'Epic_Games', 1000000.00,'Open'),
	('The International', 500, 500, 'Apex Legends', 'Teams', 'North America', '2023-10-15', 'Steam', 50000000.00,'Open'),
	('DreamHack', 800, 800, 'Fortnite', 'Teams', 'Europe', '2023-06-15', 'OG_Games', 500000.00,'Closed'),
	('PAX', 400, 400, 'FIFA 23', '1v1', 'North America', '2023-03-01', 'PlayStation_Store', 100000.00,'Open'),
	('Capcom Cup', 250, 250, 'Street Fighter V', '1v1', 'Asia', '2023-12-05', 'Microsoft_Store', 300000.00,'Open'),
	('Fortnite World Cup', 500, 500, 'Fortnite', '1v1', 'North America', '2023-07-01', 'Nintendo_eShop', 3000000.00,'Open'),
	('Overwatch League', 300, 300, 'Overwatch', 'Teams', 'North America', '2023-05-15', 'Origin', 500000.00,'Open'),
	('RLCS', 600, 600, 'Need for Speed Heat', 'Teams', 'North America', '2023-08-20', 'Uplay', 200000.00,'Open'),
	('FIFAe World Cup', 128, 128, 'FIFA 23', '1v1', 'Europe', '2023-07-15', 'Itch.io', 500000.00,'Open'),
	('CS:GO Major', 1000, 1000, 'CS:GO', 'Teams', 'Europe', '2023-11-05', 'Green_Man_Gaming', 2000000.00,'Open'),
	('Call of Duty League', 400, 400, 'Call of Duty: Modern Warfare', 'Teams', 'North America', '2023-09-20', 'Humble_Bundle', 1500000.00,'Open'),
	('Halo Championship', 300, 300, 'Halo Infinite', 'Teams', 'North America', '2023-10-10', 'Fanatical', 400000.00,'Open'),
	('Tekken World Tour', 150, 150, 'Tekken 7', '1v1', 'Asia', '2023-11-25', 'GameStop', 200000.00,'Open'),
	('Gran Turismo Cup', 128, 128, 'Gran Turismo 7', 'Teams', 'Europe', '2023-12-12', 'Best_Buy', 300000.00,'Open'),
	('Epic Games Cup', 600, 600, 'Fortnite', 'Teams', 'Africa', '2023-03-15', 'OG_Games', 750000,'Open'),
	('Fall Brawl', 250, 250, 'Street Fighter V', '1v1', 'Europe', '2023-09-01', 'GameStop', 200000,'Open'),
	('Spring Clash', 500, 500, 'Valorant',  'Teams', 'Africa', '2023-06-01', 'GameStop', 250000,'Closed'),
	('Summer Clash', 600, 600, 'Valorant', 'Teams', 'South America', '2023-07-15', 'GameStop', 300000,'Open'),
	('Winter War', 400, 400, 'PUBG', 'Teams', 'South America', '2023-09-15', 'Walmart', 300000,'Open');
